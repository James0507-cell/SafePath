...
export default function DashboardPage() {
    ...
    const handleSearch = async (e) => {
        ...
        setIsLoading(true);
        try {
            const results = await fetchPlaces(searchQuery, 100);
            setPlaces(results);
        } catch (err) {
        ...
        <div className="flex flex-col md:flex-row h-[100dvh] bg-white text-slate-800 font-sans overflow-hidden">
            ...
            <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
                ...
                <main className="flex-1 flex flex-row bg-slate-50 overflow-hidden font-sans">
                    ...
                    <div className={`${places.length > 0 && !isLoading ? 'w-[400px]' : 'w-0'} h-full bg-white border-r border-slate-200 overflow-y-auto z-40 shrink-0`}>
                                ...
                                <div className="flex flex-col gap-6">
                                    ...
                                    <div className="flex-1 flex flex-col gap-4">
                                        <div>
                                            ...
                                            <p className="text-slate-500">{selectedPlace.address}</p>
                                        </div>
